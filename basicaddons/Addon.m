...
-(void)quitApp
{
    NSDictionary* dic = [NSDictionary dictionaryWithContentsOfFile:@"/var/mobile/Library/Preferences/BeeKeyboard/basic.plist"];
    
    BOOL quitRightNow = [dic objectForKey:@"QuitRightNow"] ? [[dic objectForKey:@"QuitRightNow"] boolValue] : NO;
    
    if (showAlert || quitRightNow) {
